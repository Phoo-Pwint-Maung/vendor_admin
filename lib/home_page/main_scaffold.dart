...
import 'package:vendor_admin/vendor_manage_page/vendor_manage_screen.dart';
...
class _MainScaffoldState extends State<MainScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    if (currentPage == DrawerSection.home) {
      ...
      title = 'Add Product';
    } else if (currentPage == DrawerSection.vendorManage) {
      container = const VendorManageScreen();
      title = 'Vendor Manage';
